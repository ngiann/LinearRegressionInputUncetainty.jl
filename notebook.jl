...
using LinearRegressionInputUncetainty, PlutoUI, StatsFuns, Plots
...
@bind σ Slider(0.01:0.05:2.0, show_value=true)
...
let 
	...
	p1 = scatter(x̄, y, title="data", xlims=[-6; 6], ylims=[-9, 9])
    ...
    p2 = plot(αrange, prob, ticks = -7:1:7)
	
	plot(p1, p2, layout = (1,2) )
end

# ╔═╡ e9ec6f44-397a-4036-a1a4-47ca5f53ff45
# ╠═╡ disabled = true
#=╠═╡
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "7e53b358355c50cbd0f0f1f638cd64ef334578dd"

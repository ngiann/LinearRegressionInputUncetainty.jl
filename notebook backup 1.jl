...
let 
	x̄, y, _, r = simulatemeasurements(σ = σ, r₀ = r₀); # generate toy data
	
	m(α) =  marginalloglikelihood(α; x̄ = x̄, y = y, σ = σ, r = r) # auxiliary
...
@bind r₀vi Slider(0.01:0.05:5.0, show_value=true)
...
GaussianVariationalInference = "f96f1e2a-1be0-483a-ac4e-37f33550e2cb"
LinearRegressionInputUncetainty = "c977da63-dc55-4e90-9e9d-5cb77bb2d17a"
...
[[deps.GaussianVariationalInference]]
deps = ["ArgCheck", "Crayons", "Distributions", "ForwardDiff", "LinearAlgebra", "Optim", "Printf", "Random", "ReverseDiff", "Statistics", "Transducers", "Zygote"]
git-tree-sha1 = "2e78a752b9a1a7d380e735ebd6666808da8f8fa2"
